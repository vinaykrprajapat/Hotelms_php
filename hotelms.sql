...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2012 at 11:37 AM
...
INSERT INTO `userdetail` (`roomno`, `name`, `lname`, `contactno`, `rtype`, `itype`, `ino`, `add`, `currdate`, `fromdate`, `todate`, `status`, `book`) VALUES
(200, 'q', 'q', 345, 3, 'Passport', '789', 'dd', '24/02/12', '24/02/12', '24/02/12', '0', 0),
(211, 'Vinay', 'Kumar', 9716575144, 4, 'Driving Licence', '123', 'Delhi', '23/02/12', '', '', '1', 0),
(215, 'vk', 'mk', 789456132, 2, 'PAN', '456', '123', '23/02/12', '', '', '1', 0),
(225, 'Pawan', 'kumar', 9555202708, 3, 'Passport', '123AD', 'delhi', '22/02/12', '', '', '0', 0),
(230, 'Savan', 'Prasad', 2147483647, 2, 'PAN', 'kajshd', 'ggn', '10/2/12', '', '', '0', 0),
(250, 'Pawan', 'kumar', 897, 1, 'PAN', 'kajshd', 'ggn', '22/2/12', '', '', '0', 0),
(255, 'vk', 'sk', 567, 2, 'Passport', 'ert', 'tyu', '24/02/12', '24/02/12', '25/02/12', '0', 0);
